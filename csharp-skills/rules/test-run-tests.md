...
> Choose the repo-compatible dotnet test command and flags
...
- [test-platform-detection](test-platform-detection.md)
- [test-detect-static-dependencies](test-detect-static-dependencies.md)
