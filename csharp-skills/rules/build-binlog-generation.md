# build-binlog-generation

> Capture a binary log on every MSBuild-based command

<!-- source: dotnet/skills:SKILL.md — body verbatim, header only added -->
...
- [build-binlog-failure-analysis](build-binlog-failure-analysis.md)
- [build-directory-organization](build-directory-organization.md)
- [build-property-patterns](build-property-patterns.md)
- [build-msbuild-antipatterns](build-msbuild-antipatterns.md)
